<div class="card">      
    @php
        $media = array_merge($item['media']['data'] ?? [],$item['remoteMedia']['data'] ?? []);
    @endphp
    @if(!empty($media))
        @include("models.posts.lists.partials.image")
    @endif
    <div class="card-body d-flex flex-row">
        ...
        <div class="d-flex flex-column justify-content-start align-items-start w-100">
            ...
            <a target="_blank" href="{{ $item['source']['url'] }}" class="{{ @end($media)['invert'] }} source pr-2 d-flex justify-content-end align-items-start w-100">
